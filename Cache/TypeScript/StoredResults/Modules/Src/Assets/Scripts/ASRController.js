...
var __selfType = requireType("./ASRController");
...
let ASRController = (() => {
    ...
    var ASRController = _classThis = class extends _classSuper {
        constructor() {
            super();
            this.asr = require("LensStudio:AsrModule");
            this.options = null;
            //make an event for partial voice event that returns a string
            this.onPartialVoiceEvent = new Event_1.default();
            this.onFinalVoiceEvent = new Event_1.default();
        }
        __initialize() {
            super.__initialize();
            this.asr = require("LensStudio:AsrModule");
    ...
    __setFunctionName(_classThis, "ASRController");
    (() => {
        const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(_classSuper[Symbol.metadata] ?? null) : void 0;
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
        ASRController = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return ASRController = _classThis;
})();
exports.ASRController = ASRController;
//# sourceMappingURL=ASRController.js.map