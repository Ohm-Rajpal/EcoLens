...
uniform vec2 Port_Import_N142;
uniform float Port_Import_N141;
uniform vec2 Port_Import_N139;
...
float l9_3=radians(Port_Import_N141);
float l9_4=sin(l9_3);
float l9_5=cos(l9_3);
vec2 l9_6=l9_1-Port_Import_N139;
vec2 l9_7=((vec2(dot(vec2(l9_5,l9_4),l9_6),dot(vec2(-l9_4,l9_5),l9_6))*(Port_Import_N142*2.0))+Port_Import_N139)-Port_Import_N139;
float l9_8=l9_7.x;
float l9_9=l9_7.y;
...
vec2 l9_12=vec2(l9_11,0.0);
vec2 l9_13=vec2(1.0)-l9_12;
float l9_14=l9_13.x;
bool l9_15=(float(l9_14>=Port_Input1_N005)*1.0)!=0.0;
bool l9_16;
if (l9_15)
{
l9_16=(float(l9_14<=((((Thickness-Port_RangeMinA_N010)/((Port_RangeMaxA_N010-Port_RangeMinA_N010)+1e-06))*(Port_RangeMaxB_N010-Port_RangeMinB_N010))+Port_RangeMinB_N010))*1.0)!=0.0;
}
else
{
l9_16=l9_15;
...
vec4 l9_18=vec4(Port_Value1_N003.x,Port_Value1_N003.y,Port_Value1_N003.z,vec4(0.0).w);
l9_18.w=l9_17;
...
#endif
sc_writeFragData0(max(l9_19,vec4(0.0)));
return;
}
vec4 l9_21;
...
{
l9_24=clamp(dot(l9_18.xyz,vec3(l9_17)),0.0,1.0);
}
#else
{
float l9_25;
...
{
l9_26=(1.0-dot(l9_18.xyz,vec3(0.33333001)))*l9_17;
}
#else
{
float l9_27;
...
{
l9_27=(1.0-clamp(dot(l9_18.xyz,vec3(1.0)),0.0,1.0))*l9_17;
}
#else
{
float l9_28;
...
{
l9_28=clamp(dot(l9_18.xyz,vec3(1.0)),0.0,1.0)*l9_17;
}
#else
{
float l9_29;
#if (sc_BlendMode_Add)
{
l9_29=clamp(dot(l9_18.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_30;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_30=clamp(dot(l9_18.xyz,vec3(1.0)),0.0,1.0)*l9_17;
}
#else
{
float l9_31;
...
{
l9_31=dot(l9_18.xyz,vec3(0.33333001))*l9_17;
}
#else
{
float l9_32;
#if (sc_BlendMode_Min)
{
l9_32=1.0-clamp(dot(l9_18.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_33;
#if (sc_BlendMode_Max)
{
l9_33=clamp(dot(l9_18.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_33=1.0;
...
#endif
l9_21=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_18.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_22);
}
#else
{
vec4 l9_34;
...
#if (sc_FramebufferFetch)
{
l9_36=sc_readFragData0();
}
#else
{
vec2 l9_37=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
vec4 l9_38;
#if (sc_ScreenTextureLayout==2)
{
l9_38=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_37,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()),0.0);
}
#else
{
l9_38=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_37,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()).xy,0.0);
}
#endif
l9_36=l9_38;
}
#endif
vec3 l9_39=mix(l9_36.xyz,definedBlend(l9_36.xyz,l9_18.xyz).xyz,vec3(l9_17));
...
#if (sc_Voxelization)
{
l9_41=vec4(varScreenPos.xyz,1.0);
}
#else
{
vec4 l9_42;
#if (sc_OutputBounds)
{
float l9_43=clamp(abs(gl_FragCoord.z),0.0,1.0);
l9_42=vec4(l9_43,1.0-l9_43,1.0,1.0);
}
#else
{
vec4 l9_44;
#if (sc_BlendMode_MultiplyOriginal)
{
l9_44=vec4(mix(vec3(1.0),l9_18.xyz,vec3(l9_17)),l9_17);
}
#else
{
vec4 l9_45;
...
#endif
l9_45=vec4(l9_18.xyz*l9_46,l9_46);
}
#else
{
l9_45=l9_18;
...
vec4 l9_49=sc_OutputMotionVectorIfNeeded(max(l9_47,vec4(0.0)));
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_52=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
...
#if (sc_OITCompositingPass)
{
vec2 l9_65=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
#if (sc_OITMaxLayers4Plus1)
{
