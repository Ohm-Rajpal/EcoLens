...
uniform float Port_Position4_N003;
uniform int PreviewEnabled;
...
float l9_3=radians(Port_Rotation_N002);
vec2 l9_4=l9_1-Port_Center_N002;
float l9_5=clamp((vec2(dot(vec2(cos(l9_3),sin(l9_3)),l9_4),0.0)+Port_Center_N002).x,0.0,1.0);
vec4 l9_6;
if (l9_5<Port_Position1_N003)
{
l9_6=mix(mask_1,mask2,vec4(clamp(l9_5/Port_Position1_N003,0.0,1.0)));
}
else
{
vec4 l9_7;
if (l9_5<Port_Position2_N003)
{
l9_7=mix(mask2,Port_Value2_N003,vec4(clamp((l9_5-Port_Position1_N003)/(Port_Position2_N003-Port_Position1_N003),0.0,1.0)));
}
else
{
vec4 l9_8;
if (l9_5<Port_Position3_N003)
{
l9_8=mix(Port_Value2_N003,Port_Value3_N003,vec4(clamp((l9_5-Port_Position2_N003)/(Port_Position3_N003-Port_Position2_N003),0.0,1.0)));
}
else
{
vec4 l9_9;
if (l9_5<Port_Position4_N003)
{
l9_9=mix(Port_Value3_N003,mask2,vec4(clamp((l9_5-Port_Position3_N003)/(Port_Position4_N003-Port_Position3_N003),0.0,1.0)));
}
else
{
l9_9=mix(mask2,mask_1,vec4(clamp((l9_5-Port_Position4_N003)/(1.0-Port_Position4_N003),0.0,1.0)));
}
l9_8=l9_9;
}
l9_7=l9_8;
...
vec4 l9_10=vec4(baseColor.x,baseColor.y,baseColor.z,vec4(0.0).w);
l9_10.w=l9_6.x;
#if (sc_BlendMode_AlphaTest)
{
if (l9_6.x<alphaTestThreshold)
{
discard;
}
}
...
{
if (l9_6.x<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
#endif
sc_writeFragData0(max(l9_11,vec4(0.0)));
return;
}
vec4 l9_13;
...
{
l9_15=clamp(l9_6.x*2.0,0.0,1.0);
}
#else
{
float l9_16;
...
{
l9_16=clamp(dot(l9_10.xyz,vec3(l9_6.x)),0.0,1.0);
}
#else
{
float l9_17;
...
{
l9_18=(1.0-dot(l9_10.xyz,vec3(0.33333001)))*l9_6.x;
}
#else
{
float l9_19;
...
{
l9_19=(1.0-clamp(dot(l9_10.xyz,vec3(1.0)),0.0,1.0))*l9_6.x;
}
#else
{
float l9_20;
...
{
l9_20=clamp(dot(l9_10.xyz,vec3(1.0)),0.0,1.0)*l9_6.x;
}
#else
{
float l9_21;
#if (sc_BlendMode_Add)
{
l9_21=clamp(dot(l9_10.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_22;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_22=clamp(dot(l9_10.xyz,vec3(1.0)),0.0,1.0)*l9_6.x;
}
#else
{
float l9_23;
...
{
l9_23=dot(l9_10.xyz,vec3(0.33333001))*l9_6.x;
}
#else
{
float l9_24;
#if (sc_BlendMode_Min)
{
l9_24=1.0-clamp(dot(l9_10.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_25;
#if (sc_BlendMode_Max)
{
l9_25=clamp(dot(l9_10.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_25=1.0;
...
#endif
l9_13=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_10.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_14);
}
#else
{
vec4 l9_26;
...
{
l9_30=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_29,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()),0.0);
}
#else
{
l9_30=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_29,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()).xy,0.0);
}
#endif
l9_28=l9_30;
}
#endif
vec3 l9_31=mix(l9_28.xyz,definedBlend(l9_28.xyz,l9_10.xyz).xyz,vec3(l9_6.x));
...
#if (sc_Voxelization)
{
l9_33=vec4(varScreenPos.xyz,1.0);
}
#else
{
vec4 l9_34;
#if (sc_OutputBounds)
{
float l9_35=clamp(abs(gl_FragCoord.z),0.0,1.0);
l9_34=vec4(l9_35,1.0-l9_35,1.0,1.0);
}
#else
{
vec4 l9_36;
#if (sc_BlendMode_MultiplyOriginal)
{
l9_36=vec4(mix(vec3(1.0),l9_10.xyz,vec3(l9_6.x)),l9_6.x);
}
#else
{
vec4 l9_37;
...
vec4 l9_41=sc_OutputMotionVectorIfNeeded(max(l9_39,vec4(0.0)));
...
#if (sc_OITCompositingPass)
{
vec2 l9_57=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
#if (sc_OITMaxLayers4Plus1)
{
