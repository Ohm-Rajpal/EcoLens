...
//sampler sampler baseTextureSmpSC 0:21
...
//texture texture2D baseTexture 0:3:0:21
...
//texture texture2DArray baseTextureArrSC 0:32:0:21
...
//spec_const int SC_SOFTWARE_WRAP_MODE_U_baseTexture 76 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 77 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_baseTexture 78 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 79 -1
//spec_const int baseTextureLayout 80 0
...
int baseTextureGetStereoViewIndex()
{
int l9_0;
...
vec4 l9_3;
#if (baseTextureLayout==2)
{
bool l9_4=(int(SC_USE_CLAMP_TO_BORDER_baseTexture)!=0)&&(!(int(SC_USE_UV_MIN_MAX_baseTexture)!=0));
float l9_5=l9_1.x;
sc_SoftwareWrapEarly(l9_5,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTexture,SC_SOFTWARE_WRAP_MODE_V_baseTexture).x);
float l9_6=l9_5;
float l9_7=l9_1.y;
sc_SoftwareWrapEarly(l9_7,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTexture,SC_SOFTWARE_WRAP_MODE_V_baseTexture).y);
float l9_8=l9_7;
vec2 l9_9;
float l9_10;
#if (SC_USE_UV_MIN_MAX_baseTexture)
{
bool l9_11;
#if (SC_USE_CLAMP_TO_BORDER_baseTexture)
{
l9_11=ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTexture,SC_SOFTWARE_WRAP_MODE_V_baseTexture).x==3;
}
#else
{
l9_11=(int(SC_USE_CLAMP_TO_BORDER_baseTexture)!=0);
}
#endif
float l9_12=l9_6;
float l9_13=1.0;
sc_ClampUV(l9_12,baseTextureUvMinMax.x,baseTextureUvMinMax.z,l9_11,l9_13);
float l9_14=l9_12;
float l9_15=l9_13;
bool l9_16;
#if (SC_USE_CLAMP_TO_BORDER_baseTexture)
{
l9_16=ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTexture,SC_SOFTWARE_WRAP_MODE_V_baseTexture).y==3;
}
#else
{
l9_16=(int(SC_USE_CLAMP_TO_BORDER_baseTexture)!=0);
}
#endif
float l9_17=l9_8;
float l9_18=l9_15;
sc_ClampUV(l9_17,baseTextureUvMinMax.y,baseTextureUvMinMax.w,l9_16,l9_18);
l9_10=l9_18;
...
#endif
vec2 l9_19=sc_TransformUV(l9_9,(int(SC_USE_UV_TRANSFORM_baseTexture)!=0),baseTextureTransform);
float l9_20=l9_19.x;
float l9_21=l9_10;
sc_SoftwareWrapLate(l9_20,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTexture,SC_SOFTWARE_WRAP_MODE_V_baseTexture).x,l9_4,l9_21);
float l9_22=l9_19.y;
float l9_23=l9_21;
sc_SoftwareWrapLate(l9_22,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTexture,SC_SOFTWARE_WRAP_MODE_V_baseTexture).y,l9_4,l9_23);
float l9_24=l9_23;
vec3 l9_25=sc_SamplingCoordsViewToGlobal(vec2(l9_20,l9_22),baseTextureLayout,baseTextureGetStereoViewIndex());
vec4 l9_26=texture(baseTextureArrSC,l9_25,0.0);
vec4 l9_27;
#if (SC_USE_CLAMP_TO_BORDER_baseTexture)
{
l9_27=mix(baseTextureBorderColor,l9_26,vec4(l9_24));
}
#else
{
l9_27=l9_26;
...
#else
{
bool l9_28=(int(SC_USE_CLAMP_TO_BORDER_baseTexture)!=0)&&(!(int(SC_USE_UV_MIN_MAX_baseTexture)!=0));
float l9_29=l9_1.x;
sc_SoftwareWrapEarly(l9_29,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTexture,SC_SOFTWARE_WRAP_MODE_V_baseTexture).x);
float l9_30=l9_29;
float l9_31=l9_1.y;
sc_SoftwareWrapEarly(l9_31,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTexture,SC_SOFTWARE_WRAP_MODE_V_baseTexture).y);
float l9_32=l9_31;
vec2 l9_33;
float l9_34;
#if (SC_USE_UV_MIN_MAX_baseTexture)
...
#if (SC_USE_CLAMP_TO_BORDER_baseTexture)
{
l9_35=ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTexture,SC_SOFTWARE_WRAP_MODE_V_baseTexture).x==3;
}
#else
{
l9_35=(int(SC_USE_CLAMP_TO_BORDER_baseTexture)!=0);
}
#endif
float l9_36=l9_30;
float l9_37=1.0;
sc_ClampUV(l9_36,baseTextureUvMinMax.x,baseTextureUvMinMax.z,l9_35,l9_37);
float l9_38=l9_36;
float l9_39=l9_37;
bool l9_40;
#if (SC_USE_CLAMP_TO_BORDER_baseTexture)
{
l9_40=ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTexture,SC_SOFTWARE_WRAP_MODE_V_baseTexture).y==3;
}
#else
{
l9_40=(int(SC_USE_CLAMP_TO_BORDER_baseTexture)!=0);
}
#endif
float l9_41=l9_32;
float l9_42=l9_39;
sc_ClampUV(l9_41,baseTextureUvMinMax.y,baseTextureUvMinMax.w,l9_40,l9_42);
l9_34=l9_42;
...
#endif
vec2 l9_43=sc_TransformUV(l9_33,(int(SC_USE_UV_TRANSFORM_baseTexture)!=0),baseTextureTransform);
float l9_44=l9_43.x;
float l9_45=l9_34;
sc_SoftwareWrapLate(l9_44,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTexture,SC_SOFTWARE_WRAP_MODE_V_baseTexture).x,l9_28,l9_45);
float l9_46=l9_43.y;
float l9_47=l9_45;
sc_SoftwareWrapLate(l9_46,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTexture,SC_SOFTWARE_WRAP_MODE_V_baseTexture).y,l9_28,l9_47);
float l9_48=l9_47;
vec3 l9_49=sc_SamplingCoordsViewToGlobal(vec2(l9_44,l9_46),baseTextureLayout,baseTextureGetStereoViewIndex());
vec4 l9_50=texture(baseTexture,l9_49.xy,0.0);
vec4 l9_51;
#if (SC_USE_CLAMP_TO_BORDER_baseTexture)
{
l9_51=mix(baseTextureBorderColor,l9_50,vec4(l9_48));
}
#else
{
l9_51=l9_50;
...
#endif
float l9_52=1.0-dot(l9_3.xyz,vec3(0.29899999,0.58700001,0.114));
vec4 l9_53=vec4(Port_Value1_N006.x,Port_Value1_N006.y,Port_Value1_N006.z,vec4(0.0).w);
l9_53.w=l9_52;
...
{
l9_59=clamp(dot(l9_53.xyz,vec3(l9_52)),0.0,1.0);
}
#else
{
float l9_60;
...
{
l9_61=(1.0-dot(l9_53.xyz,vec3(0.33333001)))*l9_52;
}
#else
{
float l9_62;
...
{
l9_62=(1.0-clamp(dot(l9_53.xyz,vec3(1.0)),0.0,1.0))*l9_52;
}
#else
{
float l9_63;
...
#if (sc_BlendMode_Add)
{
l9_64=clamp(dot(l9_53.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_65;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_65=clamp(dot(l9_53.xyz,vec3(1.0)),0.0,1.0)*l9_52;
}
#else
{
float l9_66;
...
{
l9_66=dot(l9_53.xyz,vec3(0.33333001))*l9_52;
}
#else
{
float l9_67;
#if (sc_BlendMode_Min)
{
l9_67=1.0-clamp(dot(l9_53.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_68;
#if (sc_BlendMode_Max)
{
l9_68=clamp(dot(l9_53.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_68=1.0;
...
#endif
l9_56=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_53.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_57);
}
#else
{
vec4 l9_69;
...
#if (sc_FramebufferFetch)
{
l9_71=sc_readFragData0();
}
#else
{
vec2 l9_72=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
vec4 l9_73;
#if (sc_ScreenTextureLayout==2)
{
l9_73=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_72,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()),0.0);
}
#else
{
l9_73=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_72,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()).xy,0.0);
}
#endif
l9_71=l9_73;
}
#endif
vec3 l9_74=mix(l9_71.xyz,definedBlend(l9_71.xyz,l9_53.xyz).xyz,vec3(l9_52));
...
#if (sc_Voxelization)
{
l9_76=vec4(varScreenPos.xyz,1.0);
}
#else
{
vec4 l9_77;
#if (sc_OutputBounds)
{
float l9_78=clamp(abs(gl_FragCoord.z),0.0,1.0);
l9_77=vec4(l9_78,1.0-l9_78,1.0,1.0);
}
#else
{
vec4 l9_79;
#if (sc_BlendMode_MultiplyOriginal)
{
l9_79=vec4(mix(vec3(1.0),l9_53.xyz,vec3(l9_52)),l9_52);
}
#else
{
vec4 l9_80;
...
#endif
l9_80=vec4(l9_53.xyz*l9_81,l9_81);
}
#else
{
l9_80=l9_53;
...
vec4 l9_84=sc_OutputMotionVectorIfNeeded(max(l9_82,vec4(0.0)));
