...
varColor=color;
float l9_8=float(l9_0);
float l9_9;
if (sc_GeometryInfo.y>1.0)
{
l9_9=l9_8/(sc_GeometryInfo.y-1.0);
}
else
{
l9_9=0.0;
}
vec3 l9_10=normalize(Port_RotationAxis_N005);
float l9_11=radians((((l9_8-Port_RangeMinA_N050)/((Port_RangeMaxA_N050-Port_RangeMinA_N050)+1e-06))*((Port_Input0_N067*((((Tweak_N56-Port_RangeMinA_N035)/((Port_RangeMaxA_N035-Port_RangeMinA_N035)+1e-06))*(Port_RangeMaxB_N035-Port_RangeMinB_N035))+Port_RangeMinB_N035))-Port_RangeMinB_N050))+Port_RangeMinB_N050);
float l9_12=sin(l9_11);
float l9_13=cos(l9_11);
float l9_14=1.0-l9_13;
float l9_15=l9_10.x;
float l9_16=l9_14*l9_15;
float l9_17=l9_10.y;
float l9_18=l9_16*l9_17;
float l9_19=l9_10.z;
float l9_20=l9_19*l9_12;
float l9_21=l9_14*l9_19;
float l9_22=l9_21*l9_15;
float l9_23=l9_17*l9_12;
float l9_24=l9_14*l9_17;
float l9_25=l9_24*l9_19;
float l9_26=l9_15*l9_12;
float l9_27=Port_Input0_N057*Tweak_N56;
vec3 l9_28=(sc_ModelMatrixInverse*vec4(varPosAndMotion.xyz,1.0)).xyz*vec3((((l9_8-Port_RangeMinA_N025)/((Port_RangeMaxA_N025-Port_RangeMinA_N025)+1e-06))*((Port_Input0_N058*Tweak_N56)-l9_27))+l9_27);
vec3 l9_29;
vec3 l9_30;
vec3 l9_31;
if (l9_5)
...
l9_30=varNormalAndMotion.xyz;
l9_29=varPosAndMotion.xyz;
}
else
{
l9_31=varTangent.xyz;
l9_30=varNormalAndMotion.xyz;
l9_29=(sc_ModelMatrix*vec4(mat3(vec3((l9_16*l9_15)+l9_13,l9_18-l9_20,l9_22+l9_23),vec3(l9_18+l9_20,(l9_24*l9_17)+l9_13,l9_25-l9_26),vec3(l9_22-l9_23,l9_25+l9_26,(l9_21*l9_19)+l9_13))*(Port_Input0_N022+vec4(l9_28.x,l9_28.y+((((l9_8-Port_RangeMinA_N010)/((Port_RangeMaxA_N010-Port_RangeMinA_N010)+1e-06))*(Port_RangeMaxB_N010-Port_RangeMinB_N010))+Port_RangeMinB_N010),l9_28.z,0.0)).xyz,1.0)).xyz;
}
varPosAndMotion=vec4(l9_29.x,l9_29.y,l9_29.z,varPosAndMotion.w);
vec3 l9_32=normalize(l9_30);
varNormalAndMotion=vec4(l9_32.x,l9_32.y,l9_32.z,varNormalAndMotion.w);
vec3 l9_33=normalize(l9_31);
...
#if (sc_RenderingSpace==3)
{
l9_34=sc_ProjectionMatrixInverseArray[sc_GetStereoViewIndex()]*l9_1.position;
}
#else
{
vec4 l9_35;
#if (sc_RenderingSpace==2)
{
l9_35=sc_ViewMatrixArray[sc_GetStereoViewIndex()]*l9_1.position;
}
#else
{
vec4 l9_36;
#if (sc_RenderingSpace==1)
{
l9_36=sc_ModelViewMatrixArray[sc_GetStereoViewIndex()]*l9_1.position;
}
#else
{
l9_36=l9_1.position;
...
#if (sc_RenderingSpace==4)
{
l9_38=(sc_ModelViewMatrixArray[sc_GetStereoViewIndex()]*l9_1.position)*vec4(1.0/sc_Camera.aspect,1.0,1.0,1.0);
}
#else
{
vec4 l9_39;
...
#if (sc_RenderingSpace==1)
{
l9_40=sc_ViewProjectionMatrixArray[sc_GetStereoViewIndex()]*vec4(varPosAndMotion.xyz,1.0);
}
#else
{
l9_40=vec4(0.0);
...
#if (sc_RenderingSpace==1)
{
l9_41=sc_ModelMatrix*l9_1.position;
}
#else
{
l9_41=l9_1.position;
...
#if (sc_Voxelization)
{
sc_Vertex_t l9_48=sc_Vertex_t(l9_1.position,l9_1.normal,l9_1.tangent,l9_6,l9_1.texture1);
sc_BlendVertex(l9_48);
sc_SkinVertex(l9_48);
int l9_49=sc_GetLocalInstanceIDInternal(sc_FallbackInstanceID);
int l9_50=int(voxelization_params_0.w);
vec4 l9_51=createVoxelOrthoMatrix(voxelization_params_frustum_lrbt.x,voxelization_params_frustum_lrbt.y,voxelization_params_frustum_lrbt.z,voxelization_params_frustum_lrbt.w,voxelization_params_frustum_nf.x,voxelization_params_frustum_nf.y)*vec4(((sc_ModelMatrixVoxelization*l9_48.position).xyz+vec3(float(l9_49%l9_50)*voxelization_params_0.y,float(l9_49/l9_50)*voxelization_params_0.y,(float(l9_49)*(voxelization_params_0.y/voxelization_params_0.z))+voxelization_params_frustum_nf.x))-voxelization_params_camera_pos,1.0);
l9_51.w=1.0;
varScreenPos=l9_51;
sc_SetClipPosition(l9_51*1.0);
}
#else
{
#if (sc_OutputBounds)
{
sc_Vertex_t l9_52=sc_Vertex_t(l9_1.position,l9_1.normal,l9_1.tangent,l9_6,l9_1.texture1);
sc_BlendVertex(l9_52);
sc_SkinVertex(l9_52);
vec2 l9_53=((l9_52.position.xy/vec2(l9_52.position.w))*0.5)+vec2(0.5);
varTex01=vec4(l9_53.x,l9_53.y,varTex01.z,varTex01.w);
vec4 l9_54=sc_ModelMatrixVoxelization*l9_52.position;
vec3 l9_55=l9_54.xyz-voxelization_params_camera_pos;
varPosAndMotion=vec4(l9_55.x,l9_55.y,l9_55.z,varPosAndMotion.w);
vec3 l9_56=normalize(l9_52.normal);
varNormalAndMotion=vec4(l9_56.x,l9_56.y,l9_56.z,varNormalAndMotion.w);
vec4 l9_57=createVoxelOrthoMatrix(voxelization_params_frustum_lrbt.x,voxelization_params_frustum_lrbt.y,voxelization_params_frustum_lrbt.z,voxelization_params_frustum_lrbt.w,voxelization_params_frustum_nf.x,voxelization_params_frustum_nf.y)*vec4(l9_55.x,l9_55.y,l9_55.z,l9_54.w);
vec4 l9_58=vec4(l9_57.x,l9_57.y,l9_57.z,vec4(0.0).w);
l9_58.w=1.0;
varScreenPos=l9_58;
sc_SetClipPosition(l9_58*1.0);
}
#endif
}
#endif
Interpolator_gInstanceID=l9_8;
Interpolator_gInstanceRatio=l9_9;
vec4 l9_59=varPosAndMotion;
#if (sc_MotionVectorsPass)
{
vec4 l9_60=vec4(l9_59.xyz,1.0);
#if (sc_MotionVectorsPass)
{
vec4 l9_61=sc_ViewProjectionMatrixArray[sc_GetStereoViewIndex()]*l9_60;
vec4 l9_62=sc_PrevFrameViewProjectionMatrixArray[sc_GetStereoViewIndex()]*vec4(((sc_PrevFrameModelMatrix*sc_ModelMatrixInverse)*l9_60).xyz,1.0);
vec2 l9_63=((l9_61.xy/vec2(l9_61.w)).xy-(l9_62.xy/vec2(l9_62.w)).xy)*0.5;
varPosAndMotion.w=l9_63.x;
varNormalAndMotion.w=l9_63.y;
}
#endif
}
#endif
...
float l9_3=sin(l9_2);
float l9_4=cos(l9_2);
vec2 l9_5=varTex01.xy-Port_Import_N014;
...
vec2 l9_13=(varTex01.xy*vec2(Tweak_N56))+vec2(l9_1*((((l9_12-Port_RangeMinA_N046)/((Port_RangeMaxA_N046-Port_RangeMinA_N046)+1e-06))*(Port_RangeMaxB_N046-Port_RangeMinB_N046))+Port_RangeMinB_N046));
...
vec4 l9_82=sc_OutputMotionVectorIfNeeded(max(l9_80,vec4(0.0)));
