...
uniform mat4 sc_ModelMatrixInverse;
uniform float Port_objectWidth_N002;
uniform int PreviewEnabled;
...
{
l9_1=(sc_ModelMatrixInverse*vec4(varPosAndMotion.xyz,1.0)).xyz;
}
float l9_3=min(Port_objectWidth_N002,AspectRatio)*0.1;
vec2 l9_4=abs(vec2(l9_1.x*Port_objectWidth_N002,l9_1.y*AspectRatio))-((vec2(Port_objectWidth_N002,AspectRatio)*0.5)-vec2(l9_3));
float l9_5=(length(max(l9_4,vec2(0.0)))+min(max(l9_4.x,l9_4.y),0.0))-l9_3;
vec4 l9_6;
if (l9_5>0.0)
{
discard;
...
{
if (l9_5>(-(Port_objectWidth_N002*outlineThickness)))
{
l9_6=outlineColor;
}
else
...
#endif
sc_writeFragData0(max(l9_7,vec4(0.0)));
return;
}
vec4 l9_9;
...
{
l9_12=clamp(dot(l9_6.xyz,vec3(l9_6.w)),0.0,1.0);
}
#else
{
float l9_13;
...
{
l9_14=(1.0-dot(l9_6.xyz,vec3(0.33333001)))*l9_6.w;
}
#else
{
float l9_15;
...
{
l9_15=(1.0-clamp(dot(l9_6.xyz,vec3(1.0)),0.0,1.0))*l9_6.w;
}
#else
{
float l9_16;
...
{
l9_16=clamp(dot(l9_6.xyz,vec3(1.0)),0.0,1.0)*l9_6.w;
}
#else
{
float l9_17;
#if (sc_BlendMode_Add)
{
l9_17=clamp(dot(l9_6.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_18;
...
{
l9_19=dot(l9_6.xyz,vec3(0.33333001))*l9_6.w;
}
#else
{
float l9_20;
#if (sc_BlendMode_Min)
{
l9_20=1.0-clamp(dot(l9_6.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_21;
#if (sc_BlendMode_Max)
{
l9_21=clamp(dot(l9_6.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_21=1.0;
...
#endif
l9_9=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_6.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_10);
}
#else
{
vec4 l9_22;
...
#if (sc_FramebufferFetch)
{
l9_24=sc_readFragData0();
}
#else
{
vec2 l9_25=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
vec4 l9_26;
#if (sc_ScreenTextureLayout==2)
{
l9_26=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_25,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()),0.0);
}
#else
{
l9_26=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_25,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()).xy,0.0);
}
#endif
l9_24=l9_26;
}
#endif
vec3 l9_27=mix(l9_24.xyz,definedBlend(l9_24.xyz,l9_6.xyz).xyz,vec3(l9_6.w));
