...
uniform vec2 ringStroke;
uniform vec2 arcCenter;
uniform float arcSpread;
...
varColor=color;
vec4 l9_7=sc_ModelMatrixInverse*vec4(varPosAndMotion.xyz,1.0);
vec2 l9_8=l9_7.xy*dot(l9_5,ringStroke);
vec3 l9_9=vec3(l9_8.x,l9_8.y,l9_7.z);
l9_9.x=l9_8.x+dot(l9_5,ringRadius);
float l9_10=dot(l9_5,arcCenter);
float l9_11=l9_10+(arcSpread*l9_0.texture1.x);
float l9_12=cos(l9_11);
float l9_13=sin(l9_11);
vec4 l9_14=sc_ModelMatrix*vec4(dot(l9_9.xy,vec2(l9_12,-l9_13)),dot(l9_9.xy,vec2(l9_13,l9_12)),l9_7.z,1.0);
vec3 l9_15;
vec3 l9_16;
vec3 l9_17;
if (l9_4)
{
l9_17=varTangent.xyz;
l9_16=varNormalAndMotion.xyz;
l9_15=varPosAndMotion.xyz;
}
else
{
l9_17=varTangent.xyz;
l9_16=varNormalAndMotion.xyz;
l9_15=l9_14.xyz/vec3(l9_14.w);
}
varPosAndMotion=vec4(l9_15.x,l9_15.y,l9_15.z,varPosAndMotion.w);
vec3 l9_18=normalize(l9_16);
varNormalAndMotion=vec4(l9_18.x,l9_18.y,l9_18.z,varNormalAndMotion.w);
vec3 l9_19=normalize(l9_17);
...
#if (sc_RenderingSpace==3)
{
l9_20=sc_ProjectionMatrixInverseArray[sc_GetStereoViewIndex()]*l9_0.position;
}
#else
{
vec4 l9_21;
#if (sc_RenderingSpace==2)
{
l9_21=sc_ViewMatrixArray[sc_GetStereoViewIndex()]*l9_0.position;
}
#else
{
vec4 l9_22;
#if (sc_RenderingSpace==1)
{
l9_22=sc_ModelViewMatrixArray[sc_GetStereoViewIndex()]*l9_0.position;
}
#else
{
l9_22=l9_0.position;
...
#if (sc_RenderingSpace==4)
{
l9_24=(sc_ModelViewMatrixArray[sc_GetStereoViewIndex()]*l9_0.position)*vec4(1.0/sc_Camera.aspect,1.0,1.0,1.0);
}
#else
{
vec4 l9_25;
#if (sc_RenderingSpace==2)
{
l9_25=sc_ViewProjectionMatrixArray[sc_GetStereoViewIndex()]*vec4(varPosAndMotion.xyz,1.0);
}
#else
{
vec4 l9_26;
#if (sc_RenderingSpace==1)
{
l9_26=sc_ViewProjectionMatrixArray[sc_GetStereoViewIndex()]*vec4(varPosAndMotion.xyz,1.0);
}
#else
{
l9_26=vec4(0.0);
...
#if (sc_RenderingSpace==1)
{
l9_27=sc_ModelMatrix*l9_0.position;
}
#else
{
l9_27=l9_0.position;
...
#endif
vec4 l9_28=sc_ProjectorMatrix*l9_27;
varShadowTex=((l9_28.xy/vec2(l9_28.w))*0.5)+vec2(0.5);
}
#endif
vec4 l9_29;
...
{
vec4 l9_31=l9_23;
l9_31.z=((log2(max(sc_Camera.clipPlanes.x,1.0+l9_23.w))*(2.0/log2(sc_Camera.clipPlanes.y+1.0)))-1.0)*l9_23.w;
l9_30=l9_31;
}
else
{
...
#if (sc_TAAEnabled)
{
vec2 l9_33=l9_29.xy+(sc_TAAJitterOffset*l9_29.w);
l9_32=vec4(l9_33.x,l9_33.y,l9_29.z,l9_29.w);
}
#else
{
l9_32=l9_29;
...
#endif
sc_SetClipPosition(l9_32);
#if (sc_Voxelization)
{
sc_Vertex_t l9_34=sc_Vertex_t(l9_0.position,l9_0.normal,l9_0.tangent,l9_5,l9_0.texture1);
sc_BlendVertex(l9_34);
sc_SkinVertex(l9_34);
int l9_35=sc_GetLocalInstanceIDInternal(sc_FallbackInstanceID);
int l9_36=int(voxelization_params_0.w);
vec4 l9_37=createVoxelOrthoMatrix(voxelization_params_frustum_lrbt.x,voxelization_params_frustum_lrbt.y,voxelization_params_frustum_lrbt.z,voxelization_params_frustum_lrbt.w,voxelization_params_frustum_nf.x,voxelization_params_frustum_nf.y)*vec4(((sc_ModelMatrixVoxelization*l9_34.position).xyz+vec3(float(l9_35%l9_36)*voxelization_params_0.y,float(l9_35/l9_36)*voxelization_params_0.y,(float(l9_35)*(voxelization_params_0.y/voxelization_params_0.z))+voxelization_params_frustum_nf.x))-voxelization_params_camera_pos,1.0);
l9_37.w=1.0;
varScreenPos=l9_37;
sc_SetClipPosition(l9_37*1.0);
}
#else
{
#if (sc_OutputBounds)
{
sc_Vertex_t l9_38=sc_Vertex_t(l9_0.position,l9_0.normal,l9_0.tangent,l9_5,l9_0.texture1);
sc_BlendVertex(l9_38);
sc_SkinVertex(l9_38);
vec2 l9_39=((l9_38.position.xy/vec2(l9_38.position.w))*0.5)+vec2(0.5);
varTex01=vec4(l9_39.x,l9_39.y,varTex01.z,varTex01.w);
vec4 l9_40=sc_ModelMatrixVoxelization*l9_38.position;
vec3 l9_41=l9_40.xyz-voxelization_params_camera_pos;
varPosAndMotion=vec4(l9_41.x,l9_41.y,l9_41.z,varPosAndMotion.w);
vec3 l9_42=normalize(l9_38.normal);
varNormalAndMotion=vec4(l9_42.x,l9_42.y,l9_42.z,varNormalAndMotion.w);
vec4 l9_43=createVoxelOrthoMatrix(voxelization_params_frustum_lrbt.x,voxelization_params_frustum_lrbt.y,voxelization_params_frustum_lrbt.z,voxelization_params_frustum_lrbt.w,voxelization_params_frustum_nf.x,voxelization_params_frustum_nf.y)*vec4(l9_41.x,l9_41.y,l9_41.z,l9_40.w);
vec4 l9_44=vec4(l9_43.x,l9_43.y,l9_43.z,vec4(0.0).w);
l9_44.w=1.0;
varScreenPos=l9_44;
sc_SetClipPosition(l9_44*1.0);
}
#endif
}
#endif
vec4 l9_45=varPosAndMotion;
#if (sc_MotionVectorsPass)
{
vec4 l9_46=vec4(l9_45.xyz,1.0);
#if (sc_MotionVectorsPass)
{
vec4 l9_47=sc_ViewProjectionMatrixArray[sc_GetStereoViewIndex()]*l9_46;
vec4 l9_48=sc_PrevFrameViewProjectionMatrixArray[sc_GetStereoViewIndex()]*vec4(((sc_PrevFrameModelMatrix*sc_ModelMatrixInverse)*l9_46).xyz,1.0);
vec2 l9_49=((l9_47.xy/vec2(l9_47.w)).xy-(l9_48.xy/vec2(l9_48.w)).xy)*0.5;
varPosAndMotion.w=l9_49.x;
varNormalAndMotion.w=l9_49.y;
}
#endif
}
#endif
...
#endif
float l9_0=baseColor.w*opacity;
vec4 l9_1=baseColor;
l9_1.w=l9_0;
#if (sc_BlendMode_AlphaTest)
{
if (l9_0<alphaTestThreshold)
{
discard;
}
}
...
{
if (l9_0<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
{
l9_5=clamp(dot(l9_1.xyz,vec3(l9_0)),0.0,1.0);
}
#else
{
float l9_6;
...
{
l9_7=(1.0-dot(l9_1.xyz,vec3(0.33333001)))*l9_0;
}
#else
{
float l9_8;
...
{
l9_8=(1.0-clamp(dot(l9_1.xyz,vec3(1.0)),0.0,1.0))*l9_0;
}
#else
{
float l9_9;
...
{
l9_9=clamp(dot(l9_1.xyz,vec3(1.0)),0.0,1.0)*l9_0;
}
#else
{
float l9_10;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_11=clamp(dot(l9_1.xyz,vec3(1.0)),0.0,1.0)*l9_0;
}
#else
{
float l9_12;
...
{
l9_12=dot(l9_1.xyz,vec3(0.33333001))*l9_0;
}
#else
{
float l9_13;
...
#if (sc_FramebufferFetch)
{
l9_17=sc_readFragData0();
}
#else
{
vec2 l9_18=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
vec4 l9_19;
#if (sc_ScreenTextureLayout==2)
{
l9_19=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_18,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()),0.0);
}
#else
{
l9_19=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_18,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()).xy,0.0);
}
#endif
l9_17=l9_19;
}
#endif
vec3 l9_20=mix(l9_17.xyz,definedBlend(l9_17.xyz,l9_1.xyz).xyz,vec3(l9_0));
...
#if (sc_Voxelization)
{
l9_22=vec4(varScreenPos.xyz,1.0);
}
#else
{
vec4 l9_23;
#if (sc_OutputBounds)
{
float l9_24=clamp(abs(gl_FragCoord.z),0.0,1.0);
l9_23=vec4(l9_24,1.0-l9_24,1.0,1.0);
}
#else
{
vec4 l9_25;
#if (sc_BlendMode_MultiplyOriginal)
{
l9_25=vec4(mix(vec3(1.0),l9_1.xyz,vec3(l9_0)),l9_0);
}
#else
{
vec4 l9_26;
...
#endif
l9_26=vec4(l9_1.xyz*l9_27,l9_27);
}
#else
{
l9_26=l9_1;
...
vec4 l9_30=sc_OutputMotionVectorIfNeeded(max(l9_28,vec4(0.0)));
vec4 l9_31=clamp(l9_30,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_32=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0(vec4(max(0.0,1.0-(l9_32-0.0039215689)),min(1.0,l9_32+0.0039215689),0.0,0.0));
}
#endif
}
#else
...
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_33).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_34=encodeDepth(viewSpaceDepth(),texture(sc_OITFilteredDepthBoundsTexture,l9_33).xy);
float l9_35=packValue(l9_34);
int l9_42=int(l9_31.w*255.0);
float l9_43=packValue(l9_42);
sc_writeFragData0(vec4(packValue(l9_34),packValue(l9_34),packValue(l9_34),packValue(l9_34)));
}
#endif
}
#else
...
#if (sc_OITCompositingPass)
{
vec2 l9_46=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
#if (sc_OITMaxLayers4Plus1)
{
...
if (l9_51==0)
{
l9_54=texture(sc_OITAlpha0,l9_46);
l9_53=texture(sc_OITDepthLow0,l9_46);
l9_52=texture(sc_OITDepthHigh0,l9_46);
}
else
{
l9_54=vec4(0.0);
...
if (l9_51==1)
{
l9_57=texture(sc_OITAlpha1,l9_46);
l9_56=texture(sc_OITDepthLow1,l9_46);
l9_55=texture(sc_OITDepthHigh1,l9_46);
}
else
{
l9_57=l9_54;
...
if (any(notEqual(l9_55,vec4(0.0)))||any(notEqual(l9_56,vec4(0.0))))
{
int l9_58[8]=l9_47;
unpackValues(l9_55.w,l9_51,l9_58);
unpackValues(l9_55.z,l9_51,l9_58);
unpackValues(l9_55.y,l9_51,l9_58);
unpackValues(l9_55.x,l9_51,l9_58);
unpackValues(l9_56.w,l9_51,l9_58);
unpackValues(l9_56.z,l9_51,l9_58);
unpackValues(l9_56.y,l9_51,l9_58);
unpackValues(l9_56.x,l9_51,l9_58);
int l9_67[8]=l9_48;
unpackValues(l9_57.w,l9_51,l9_67);
unpackValues(l9_57.z,l9_51,l9_67);
unpackValues(l9_57.y,l9_51,l9_67);
unpackValues(l9_57.x,l9_51,l9_67);
}
l9_51++;
continue;
}
...
vec4 l9_72=texture(sc_OITFilteredDepthBoundsTexture,l9_46);
vec2 l9_73=l9_72.xy;
int l9_74;
#if (sc_SkinBonesCount>0)
{
l9_74=encodeDepth(((1.0-l9_72.x)*1000.0)+getDepthOrderingEpsilon(),l9_73);
}
#else
{
l9_74=0;
...
#endif
int l9_75=encodeDepth(viewSpaceDepth(),l9_73);
vec4 l9_76;
l9_76=l9_31*l9_31.w;
vec4 l9_77;
int l9_78=0;
...
if (l9_78<8)
{
int l9_79=l9_47[l9_78];
int l9_80=l9_75-l9_74;
bool l9_81=l9_79<l9_80;
bool l9_82;
if (l9_81)
{
l9_82=l9_47[l9_78]>0;
...
if (l9_82)
{
vec3 l9_83=l9_76.xyz*(1.0-(float(l9_48[l9_78])/255.0));
l9_77=vec4(l9_83.x,l9_83.y,l9_83.z,l9_76.w);
}
else
{
l9_77=l9_76;
