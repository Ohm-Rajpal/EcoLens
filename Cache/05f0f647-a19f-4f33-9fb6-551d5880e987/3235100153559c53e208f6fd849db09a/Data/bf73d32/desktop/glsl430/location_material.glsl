...
//spec_const bool sc_RayTracingReflectionsHasSwappedViews 72 0
//spec_const bool sc_RayTracingShadowsHasSwappedViews 73 0
//spec_const bool sc_RenderAlphaToColor 74 0
//spec_const bool sc_SSAOEnabled 75 0
...
//spec_const int SC_DEVICE_CLASS 81 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 82 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 83 -1
...
//spec_const int sc_PointLightsCount 99 0
//spec_const int sc_RayTracingGlobalIlluminationLayout 100 0
//spec_const int sc_RayTracingReflectionsLayout 101 0
//spec_const int sc_RayTracingShadowsLayout 102 0
...
#endif
if ((float(varColor.w>Port_Input1_N012)*1.0)!=0.0)
{
}
else
{
...
#endif
uvec3 l9_1=uvec3(round((varPosAndMotion.xyz-sc_RayTracingOriginOffset)*sc_RayTracingOriginScale));
sc_RayTracingPositionAndMask=uvec4(l9_1.x,l9_1.y,l9_1.z,sc_RayTracingPositionAndMask.w);
sc_RayTracingPositionAndMask.w=sc_RayTracingReceiverMask;
vec3 l9_2=l9_0/vec3(dot(abs(l9_0),vec3(1.0)));
vec2 l9_3=vec2(clamp(-l9_2.z,0.0,1.0));
vec2 l9_4=l9_2.xy;
uint l9_5=packHalf2x16(l9_4+mix(-l9_3,l9_3,step(vec2(0.0),l9_4)));
uvec2 l9_6=uvec2(l9_5&65535u,l9_5>>16u);
sc_RayTracingNormalAndMore=uvec4(l9_6.x,l9_6.y,sc_RayTracingNormalAndMore.z,sc_RayTracingNormalAndMore.w);
...
vec4 l9_6;
if ((float(l9_4.w>Port_Input1_N012)*1.0)!=0.0)
{
l9_6=l9_4;
}
else
...
#if (sc_ProjectiveShadowsCaster)
{
l9_8=vec4(Port_Albedo_N006,Port_Opacity_N006);
}
#else
{
l9_8=ngsCalculateLighting(Port_Albedo_N006,Port_Opacity_N006,l9_7,l9_2,l9_3,Port_Emissive_N006,Port_Metallic_N006,Port_Roughness_N006,Port_AO_N006,Port_SpecularAO_N006);
}
#endif
l9_6=max(l9_8,vec4(0.0));
}
if (l9_0)
{
vec4 l9_9;
...
#if (sc_BlendMode_PremultipliedAlpha)
{
l9_13=clamp(l9_6.w*2.0,0.0,1.0);
}
#else
{
float l9_14;
...
{
l9_14=clamp(dot(l9_6.xyz,vec3(l9_6.w)),0.0,1.0);
}
#else
{
float l9_15;
...
#if (sc_BlendMode_Multiply)
{
l9_16=(1.0-dot(l9_6.xyz,vec3(0.33333001)))*l9_6.w;
}
#else
{
float l9_17;
...
{
l9_17=(1.0-clamp(dot(l9_6.xyz,vec3(1.0)),0.0,1.0))*l9_6.w;
}
#else
{
float l9_18;
#if (sc_BlendMode_ColoredGlass)
{
l9_18=clamp(dot(l9_6.xyz,vec3(1.0)),0.0,1.0)*l9_6.w;
}
#else
{
float l9_19;
#if (sc_BlendMode_Add)
{
l9_19=clamp(dot(l9_6.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_20;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_20=clamp(dot(l9_6.xyz,vec3(1.0)),0.0,1.0)*l9_6.w;
}
#else
{
float l9_21;
...
{
l9_21=dot(l9_6.xyz,vec3(0.33333001))*l9_6.w;
}
#else
{
float l9_22;
#if (sc_BlendMode_Min)
{
l9_22=1.0-clamp(dot(l9_6.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_23;
...
#endif
l9_11=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_6.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_12);
}
#else
{
vec4 l9_24;
...
vec3 l9_27=mix(l9_26,definedBlend(l9_26,l9_6.xyz).xyz,vec3(l9_6.w));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_32=vec4(mix(vec3(1.0),l9_6.xyz,vec3(l9_6.w)),l9_6.w);
}
#else
{
vec4 l9_33;
...
#endif
l9_33=vec4(l9_6.xyz*l9_34,l9_34);
}
#else
{
l9_33=l9_6;
